...
Sideshow.registerWizard({
  ...
  affects: [
    ...
    // indicating if this tutorial will be available. As a simple example we're
    // returning a true, so this tutorial would be available in any context.
    () => true
  ]
}).storyLine({
  ...
  steps: [
    {
      ...
      text: `
        ...
        UI. Go ahead and let's see some powerful features.
      `
    },
    {
      title: "The Subject",
      text: `
        ...
        explaining a concept, but at the most part of time, you're explaining
        some visual part of a screen or a page (e.g. a form, button, div, grid
        and so forth). We call these visual parts subjects. A subject of a step
        is just an element of your page you're aiming to stand out from the rest
        (when user is seeing that especific step) to comment/explain something
        about it.
      `
    },
    {
    ...
    },
    {
      ...
      text: `
        ...
        look at the subject with no doubt where it's located. If you're curious
    ...
    },
    {
      ...
      text: `
        ...
        is that user (obviously you =D) has to drag the Dr. Brown photo and drop
    ...
    },
    {
      ...
      text: `
        ...
        which can be tested programmatically). If your tutorials are registered
        and imported globally, for your whole application, you can create rules
        for each one (if it will be listed in the Sideshow menu).
    ...
    },
    {
      ...
      text: `
        There's a wide variety of interesting features in this version of
        Sideshow, some of which we didn't mention in this introductory tutorial.
        Take this sample, the documentation, open your favorite editor for
        Javascript and play at will!
      `
    }
  ]
});
